...
@shared_task
def send_notification(follow_account_id):
  firebase_admin_sdk = {
  ...
  # 1. inviter(riku)がikutoさんをquouzeに招待(この時rikuのuserIdを持っている)
  # 2. ikutoさんのinviterにaccountId(40が入ってる)
  # 3. ikutoさんがaccountを作成した時、rikuにnotificationを送る


  # This registration token comes from the client FCM SDKs.
  device = Device.objects.filter(account=follow_account_id).first()
  registration_token = device.fcm_token
  # 'eQhr2UaSOkoYlFRAjMumvH:APA91bEuh3x599x2eXVcJL_hP_rMRrtvbdVmcohmoEkBAkFa8WHBk57x-QONGKZb0OLlvwkslqjT4vA0b-Y_FRg_6hEz0YBAVjtMDu1F21pqLB6fVdrVTs9I9jrJB-pn87ktjZXTfQQL'
